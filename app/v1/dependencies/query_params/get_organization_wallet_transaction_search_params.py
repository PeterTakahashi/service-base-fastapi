...
from app.v1.schemas.organization_wallet_transaction.search_params import (
    OrganizationWalletTransactionSearchParams,
)


def get_organization_wallet_transaction_search_params(
    ...
    return OrganizationWalletTransactionSearchParams(
        limit=limit,
        offset=offset,
        sorted_by=sorted_by,
