...
from app.lib.fastapi_users.transport.oauth_cookie_transport import oauth_cookie_transport

def get_jwt_strategy() -> JWTStrategy:
    return JWTStrategy(
        secret=settings.JWT_SECRET, lifetime_seconds=settings.ACCESS_TOKEN_EXPIRED_SECONDS
    )
