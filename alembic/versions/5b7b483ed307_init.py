...
Revision ID: 5b7b483ed307
Revises: 
Create Date: 2025-06-21 06:54:46.967194
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('user_id', 'organization_id', name='uq_user_organization_assignment')
    )
