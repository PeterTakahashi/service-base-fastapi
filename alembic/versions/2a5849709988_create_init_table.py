...
Revision ID: 2a5849709988
Revises:
Create Date: 2025-04-22 05:01:30.952097
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "display_id", fastapi_users_db_sqlalchemy.generics.GUID(), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_products_display_id"), "products", ["display_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_characters_display_id"), "characters", ["display_id"], unique=False
    )
    op.create_index(op.f("ix_characters_name"), "characters", ["name"], unique=False)
    op.create_index(
        op.f("ix_characters_product_id"), "characters", ["product_id"], unique=False
    )
    op.create_table(
        "episodes",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_episodes_display_id"), "episodes", ["display_id"], unique=False
    )
    op.create_index(
        op.f("ix_episodes_product_id"), "episodes", ["product_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_character_images_character_id"),
        "character_images",
        ["character_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_character_images_display_id"),
        "character_images",
        ["display_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_character_images_character_id"), table_name="character_images"
    )
